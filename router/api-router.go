...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		siteModelCallsRoute := apiRouter.Group("/site-model-calls")
		siteModelCallsRoute.Use(middleware.UserAuth())
		{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/perpay/notify", anonymousRequestBodyLimit, controller.PerPayNotify)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/perpay/pay", middleware.CriticalRateLimit(), controller.RequestPerPay)
		...
		dataRoute.GET("/token-trend", middleware.AdminAuth(), controller.GetAllTokenTrend)
		dataRoute.GET("/token-trend/self", middleware.UserAuth(), controller.GetUserTokenTrend)
		dataRoute.GET("/token-trend/users/:id", middleware.AdminAuth(), controller.GetTokenTrendUser)
